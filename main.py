...
def main(inputsFolder = 'inputs/', resultsFolder = 'results/'):
    ...
    # oldFunc_totalMSE = evalBS_noGrad(None, f'{resultsFolder}oldFunc_plotBS.pdf', 'Old Zunger BS', NNConfig, hams, systems, cachedMats_info, writeBS=True, LSDmodels=None)
