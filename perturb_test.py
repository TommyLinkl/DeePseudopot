...
def perturb(inputsFolder = 'inputs_evalFullBand/', resultsFolder = 'results_evalFullBand/'):
    ...
    FT_converge_and_write_pp(atomPPOrder, qmax, nQGrid, nRGrid, PPmodel, ZungerPPFunc_val, 0.0, 8.0, -2.0, 1.0, 20.0, 2048, 2048, f'{resultsFolder}initZunger_plotPP', f'{resultsFolder}initZunger_pot', NNConfig['SHOWPLOTS'], lr_params=lr_params, pp_params=PPparams, lr_gamma=lr_gamma_value)
